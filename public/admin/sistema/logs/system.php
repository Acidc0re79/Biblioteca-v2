<?php
// Sube dos niveles (desde /logs/sistema/) para encontrar la carpeta 'includes' en /admin/
    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                ...
                <p>Eventos generales del sistema (logins, registros, errores de BD, etc.)</p>
                <div class="logs-container-scrollable">
                    <?php if (empty($system_logs)): ?>
                        <div class="log-card"><div class="log-card-body"><p>No hay entradas en el log del sistema.</p></div></div>
                    <?php else: ?>
                        <?php foreach ($system_logs as $index => $log): ?>
                            <div class="log-card">
                                <div class="log-card-header">
                                    <span class="log-chip"><?= strtoupper(htmlspecialchars($log['level'] ?? 'LOG')) ?></span>
